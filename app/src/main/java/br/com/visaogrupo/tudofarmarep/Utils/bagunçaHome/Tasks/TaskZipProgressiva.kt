...
import br.com.visaogrupo.tudofarmarep.Utils.bagunçaHome.RetrofitCliente
...
class TaskZipProgressiva {
    suspend fun buscaZipProgressiva(context: Context, uf:String):String {
        try {
            try {
    ...
    fun saveToDisk(body: ResponseBody, context: Context):String {
        ...
        try {
            ...
            var destinationFile = File("/data/data/" + context.packageName + "/carga/Progressiva.zip")
